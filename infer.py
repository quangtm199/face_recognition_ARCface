...
with open('/home/quang/Downloads/arcface-pytorch/pretrainModel_ARC/X_train_triplet.pkl', 'rb') as f:
    X = pickle.load(f)
    X = np.array(X)
#     X = np.expand_dims(X, axis=3)
with open('/home/quang/Downloads/arcface-pytorch/pretrainModel_ARC/y_train_triplet.pkl', 'rb') as f:
    y = pickle.load(f)
    y = np.array(y)

with open('/home/quang/Downloads/arcface-pytorch/pretrainModel_ARC/name_map.pkl', 'rb') as f:
...
image = cv2.imread("/home/quang/Downloads/arcface-pytorch/data/Datasets/lfw/tranquang/tranquang1.jpg", 0)
